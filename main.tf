...
module "s3_code_upload" {
    ...
    source_file = "./lambda.py"  # Path to the source file that needs to be zipped and uploaded
...
module "lambda_code" {
    ...
    function_name = "firmware_lambda"  # Name of the Lambda function to be created
